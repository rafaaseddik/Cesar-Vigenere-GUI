...
class DecodeGui(Frame):
    ...
    def init_window(self):
        ...
        # creating labels
        self.mainTitle = Label(self.frame,text="Vigenere Decoder",fg="red",font=("Courier", 20))
        ...
        self.encodeButton = Button(self.frame, text="Decoder", command = self.decode,font=buttonFont)
